...
public class Validate {
	...
	public static void main(String[] args) {
		...
		//valida a entrada de usuario e exibe a mensagem de erro na area
		...
		if (!ValidateInput.validateFirstName(firstName))
			...
			System.out.println("Invalid last address!");
			...
			System.out.println("Valid input the system. Thank You!");
	}
